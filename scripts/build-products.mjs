...
function confirmedPreorderFor(product){
  ...
  return {
    ...
    scopeLabel:isYoga?"Incoming stock · No minimum":"In production · No minimum",
    title:isYoga?"Glacier Blue is allocated from incoming stock.":"Production is confirmed — no minimum quantity required.",
...
<link rel="icon" href="../logo.png"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@300;400;500;600&amp;family=Manrope:wght@400;500;600;700&amp;display=swap" rel="stylesheet"><link rel="stylesheet" href="../product-page.css?v=20260907-conversion-review"><link rel="stylesheet" href="../cookie-consent.css">
<script type="application/ld+json">${JSON.stringify(schemaFor(product,variants))}</script><link rel="stylesheet" href="../conversion-review.css?v=20260907"></head>
