...
const products=[
  ...
  {slug:"coast-go",prefix:"Coast Go iSUP",name:"AURA PADDLE CoastGo",short:"CoastGo",series:"CoastGo Series",category:"All-round inflatable paddleboard",description:"An approachable all-round inflatable paddleboard package for first paddles, weekends and easy transport.",status:"All 3 colours available",badge:"All-round",price:"AUD $349",canBuy:true,stock:"In stock · Dispatch confirmed with order",sizes:["10'6\""],colourKeys:["blueorange","mintgrey","bluecoral"],images:{},specs:[["Length","10'6\""],["Width","33\""],["Thickness","6\""],["Volume","249 L"],["Maximum capacity","120 kg"],["Format","All-round iSUP"]],included:["CoastGo board","Carry bag","Adjustable 3-piece paddle","Single-action pump","10ft leg rope","2+1 removable fins","Waterproof phone pouch","Repair kit"],bestFor:"First-time paddlers, casual weekends and customers who want an accessible complete all-round package.",notFor:"Heavy fishing loads, specialised yoga use or long-distance performance touring.",why:"Its 10'6\" all-round format balances stability, portability and straightforward handling.",photoNeed:"Top, bottom, side, three-quarter, full-kit and on-water photographs are required for all three colours."},
