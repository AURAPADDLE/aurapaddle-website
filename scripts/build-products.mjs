...
const products=[
  ...
  {slug:"inflatable-hydrofoil",prefix:"AURA Inflatable Hydrofoil",name:"AURA PADDLE Inflatable Hydrofoil Board",short:"Inflatable Hydrofoil Board",series:"Foil Series",category:"Inflatable hydrofoil board",description:"A portable inflatable hydrofoil platform for wing-foil progression and travel; final package contents require confirmation before sale.",status:"Pre-launch · Bundle confirmation required",badge:"Foil",price:"Price on enquiry",canBuy:false,stock:"Pre-launch enquiry",sizes:["5'7\""],colourKeys:["foil"],images:{},sizeGuide:[{size:"5'7\"",width:"27.5\"",thickness:"6\"",volume:"110 L"}],specs:[["Length","5'7\" / 170 cm"],["Width","27.5\" / 70 cm"],["Thickness","6\" / 15 cm"],["Volume","110 L"],["Maximum pressure","20 PSI"],["Package","Final contents to be confirmed"]],included:["Inflatable foil board","Safety hand rope","Final hydrofoil, wing, bag and accessory bundle to be confirmed"],bestFor:"Customers who prioritise packability and are progressing into wing foiling with an inflatable platform.",notFor:"Purchase before the exact included hydrofoil, wing, fins and accessory bundle has been formally confirmed.",why:"The inflatable 110-litre platform is designed around transport and storage convenience.",photoNeed:"Complete assembled-system, verified kit flat lay, setup details, packed-bag and on-water action photography are required."},
...
const productCopy={
  ...
  "inflatable-hydrofoil":{
    description:"A packable 110-litre inflatable platform for riders developing their wing-foil skills or travelling with limited storage space. The compact 5'7\" format keeps transport practical, while the dedicated foil connection provides the foundation for progression once the final system bundle is confirmed.",
