...
function confirmedPreorderFor(product){
  ...
  return {
    ...
    name:"Confirmed Pre-order",
    target:0,
    thresholdRequired:false,
    scopeLabel:"No minimum quantity",
    title:"Production is confirmed — no minimum quantity required.",
    description:"Your board is reserved in a confirmed production schedule. This pre-order is not conditional on a minimum order quantity.",
...
function preorderStatus(preorder){return preorder.thresholdRequired?`${preorder.scopeLabel} 0/${preorder.target}`:`Confirmed · ${preorder.scopeLabel}`}
...
const products=[
  {slug:"yoga-cruiser",prefix:"Yoga Cruiser",name:"AURA PADDLE Yoga Cruiser",short:"Yoga Cruiser",series:"Yoga Cruiser Series",category:"Inflatable paddleboard",description:"An extra-wide inflatable stand-up paddleboard for SUP yoga, shared paddles and stable family use in Australian waters.",status:"1 colour available · 3 colours on pre-order",badge:"Yoga & family",price:"AUD $799",canBuy:true,stock:"In stock · Dispatch confirmed with order",sizes:["11'0\""],colourKeys:supColourKeys,images:{glacier:["../assets/products/yoga-cruiser/glacier-blue/AP734955_yoga-cruiser_11ft_glacier-blue_hero-01.webp","../assets/products/yoga-cruiser/glacier-blue/AP734955_yoga-cruiser_11ft_glacier-blue_deck-02.webp","../assets/products/yoga-cruiser/glacier-blue/AP734955_yoga-cruiser_11ft_glacier-blue_bottom-03.webp","../assets/products/yoga-cruiser/glacier-blue/AP734955_yoga-cruiser_11ft_glacier-blue_side-04.webp","../assets/products/yoga-cruiser/glacier-blue/AP734955_yoga-cruiser_11ft_glacier-blue_three-quarter-05.webp","../assets/products/yoga-cruiser/glacier-blue/AP734955_yoga-cruiser_11ft_glacier-blue_deck-detail-06.webp","../assets/products/yoga-cruiser/glacier-blue/AP734955_yoga-cruiser_11ft_glacier-blue_full-kit-07.webp","../assets/products/yoga-cruiser/glacier-blue/AP734955_yoga-cruiser_11ft_glacier-blue_yoga-lifestyle-08.webp","../assets/products/yoga-cruiser/glacier-blue/AP734955_yoga-cruiser_11ft_glacier-blue_colour-lineup-09.webp"],sandstone:["../pic 3 matte sandstone.png"],eucalyptus:["../assets/products/yoga-cruiser/eucalyptus-green/AP233694_yoga-cruiser_11ft_eucalyptus-green_hero-01.webp","../assets/products/yoga-cruiser/eucalyptus-green/AP233694_yoga-cruiser_11ft_eucalyptus-green_deck-02.webp","../assets/products/yoga-cruiser/eucalyptus-green/AP233694_yoga-cruiser_11ft_eucalyptus-green_bottom-03.webp","../assets/products/yoga-cruiser/eucalyptus-green/AP233694_yoga-cruiser_11ft_eucalyptus-green_side-04.webp","../assets/products/yoga-cruiser/eucalyptus-green/AP233694_yoga-cruiser_11ft_eucalyptus-green_three-quarter-05.webp","../assets/products/yoga-cruiser/eucalyptus-green/AP233694_yoga-cruiser_11ft_eucalyptus-green_deck-detail-06.webp","../assets/products/yoga-cruiser/eucalyptus-green/AP233694_yoga-cruiser_11ft_eucalyptus-green_full-kit-07.webp","../assets/products/yoga-cruiser/eucalyptus-green/AP233694_yoga-cruiser_11ft_eucalyptus-green_yoga-lifestyle-08.webp","../assets/products/yoga-cruiser/eucalyptus-green/AP233694_yoga-cruiser_11ft_eucalyptus-green_colour-lineup-09.webp"],coral:["../pic 5 coral white.png"]},specs:[["Length","11'0\""],["Width","36\""],["Thickness","6\""],["Volume","285 L"],["Maximum capacity","180 kg"],["Construction","Woven drop stitch"]],included:["Yoga Cruiser board","Wheeled carry bag","Adjustable 3-piece paddle","Electric pump","10ft coiled leash","2+1 removable fins","Waterproof phone pouch","Repair kit"],bestFor:"SUP yoga, beginners who prioritise stability, relaxed family paddles and carrying a seated passenger within the stated capacity.",notFor:"Riders whose main priority is maximum touring speed, narrow race-style tracking or specialised fishing mounts.",why:"The 36-inch platform and 285-litre volume prioritise stability and usable deck space.",photoNeed:"Glacier Blue and Eucalyptus Green have detailed imagery. Matte Sandstone and Coral White still need complete top, bottom, side and lifestyle photography."},
  ...
  {slug:"touring-performance",prefix:"Touring Performance",name:"AURA PADDLE Touring Performance",short:"Touring Performance",series:"Touring Performance Series",category:"Touring inflatable paddleboard",description:"A 14-foot touring iSUP shaped for efficient tracking, distance and fast open-water paddling.",status:"Range preview",badge:"Touring",price:"From AUD $1499",canBuy:false,stock:"Availability confirmed by enquiry",sizes:["14'0\""],colourKeys:supColourKeys,images:{glacier:["../pic 11 toring glacier blue.png"],sandstone:["../pic 12 toring matte sandstone.png"],eucalyptus:["../pic 13 toring eucalyptus green.png"],coral:["../pic 14 toring coral white.png"]},specs:[["Length","14'0\""],["Width","30\""],["Thickness","5.5\""],["Volume","302.4 L"],["Maximum capacity","150 kg"],["Hull","V hull and speed tail"]],included:["Touring Performance board","Wheeled carry bag","Adjustable 3-piece paddle","Electric pump","10ft coiled leash","2+1 removable fins","Waterproof phone pouch","Repair kit"],bestFor:"Longer distances, efficient tracking and paddlers who value glide and speed over maximum width.",notFor:"SUP yoga, fishing loads or riders who require the widest and most forgiving first-time platform.",why:"The 14-foot length, 30-inch width, V hull and speed tail are intended to support tracking and glide.",photoNeed:"All four catalogue colours have renders; detailed construction and on-water touring photography is still required."},
  {slug:"coast-go",prefix:"Coast Go iSUP",name:"AURA PADDLE CoastGo",short:"CoastGo",series:"CoastGo Series",category:"All-round inflatable paddleboard",description:"An approachable all-round inflatable paddleboard package for first paddles, weekends and easy transport.",status:"All 3 colours available",badge:"All-round",price:"AUD $349",canBuy:true,stock:"In stock · Dispatch confirmed with order",sizes:["10'6\""],colourKeys:["blueorange","mintgrey","bluecoral"],images:{},specs:[["Length","10'6\""],["Width","33\""],["Thickness","6\""],["Volume","249 L"],["Maximum capacity","120 kg"],["Format","All-round iSUP"]],included:["CoastGo board","Carry bag","Adjustable 3-piece paddle","Dual-action pump","10ft leg rope","2 fixed + 1 removable fins","Waterproof phone pouch","Repair kit"],bestFor:"First-time paddlers, casual weekends and customers who want an accessible complete all-round package.",notFor:"Heavy fishing loads, specialised yoga use or long-distance performance touring.",why:"Its 10'6\" all-round format balances stability, portability and straightforward handling.",photoNeed:"Top, bottom, side, three-quarter, full-kit and on-water photographs are required for all three colours."},
  {slug:"inflatable-hydrofoil",prefix:"AURA Inflatable Hydrofoil",name:"AURA PADDLE Inflatable Hydrofoil Board",short:"Inflatable Hydrofoil Board",series:"Foil Series",category:"Inflatable hydrofoil board",description:"A portable inflatable hydrofoil platform for wing-foil progression and travel; final package contents require confirmation before sale.",status:"Pre-launch · Bundle confirmation required",badge:"Foil",price:"Price on enquiry",canBuy:false,stock:"Pre-launch enquiry",sizes:["5'8\""],colourKeys:["foil"],images:{},specs:[["Length","5'8\" / 170 cm"],["Width","27.5\" / 70 cm"],["Thickness","4.75\" / 15 cm"],["Volume","150 L"],["Maximum pressure","20 PSI"],["Package","Final contents to be confirmed"]],included:["Inflatable foil board","Safety hand rope","Final hydrofoil, wing, bag and accessory bundle to be confirmed"],bestFor:"Customers who prioritise packability and are progressing into wing foiling with an inflatable platform.",notFor:"Purchase before the exact included hydrofoil, wing, fins and accessory bundle has been formally confirmed.",why:"The inflatable 150-litre platform is designed around transport and storage convenience.",photoNeed:"Complete assembled-system, verified kit flat lay, setup details, packed-bag and on-water action photography are required."},
  {slug:"hydrofoil-set",prefix:"",name:"AURA PADDLE Hydrofoil Kit Set",short:"Hydrofoil Kit Set",series:"Foil Series",category:"Hydrofoil kit set",description:"A lightweight and durable hydrofoil kit built with carbon-fibre components to reduce overall weight while maintaining strength and responsive performance. The aluminium-alloy fuselage provides a strong, dependable connection through the centre of the foil system. Supplied as a complete set with mast, fuselage, front wing, rear wing, mast top plate and screw sets for compatible foil-board setups.",status:"Pre-order",badge:"Foil",price:"AUD $1,499",canBuy:true,stock:"Pre-order · 50% due today",sizes:["Set"],colourKeys:["standard"],images:{},manualVariants:[{size:"Set",colourKey:"standard",sku:"AP246531",specification:"Hydrofoil Kit Set",retailAUD:1499}],specs:[["Product type","Hydrofoil kit set"],["Product SKU","AP246531"],["Primary construction","Carbon fibre"],["Mast","750 × 130 mm"],["Fuselage","642 mm · aluminium alloy"],["Front wing","1310 × 187 mm"],["Rear wing","390 × 90 mm"],["Mast top plate","168 × 120 mm"],["Hardware","Screw sets included"],["Compatibility","Confirm with AURA PADDLE before ordering"]],included:["Mast — 750 × 130 mm","Fuselage — 642 mm · aluminium alloy","Front wing — 1310 × 187 mm","Rear wing — 390 × 90 mm","Mast top plate — 168 × 120 mm","Screw sets"],bestFor:"Riders seeking a lightweight, durable hydrofoil kit for a compatible foil-board setup after confirming fit and intended use.",notFor:"Ordering before board compatibility has been confirmed with AURA PADDLE.",why:"Carbon-fibre components deliver an efficient strength-to-weight balance for easier transport and responsive handling, while the aluminium-alloy fuselage adds dependable structural support through the core of the system.",photoNeed:"Complete product, component, detail and carry-bag photography is available."},
...
const metaDescriptions={
  ...
  "inflatable-hydrofoil":"A packable 5ft 8in, 150L inflatable hydrofoil board for wing-foil progression, travel and compact storage in Australia.",
...
const productCopy={
  ...
  "inflatable-hydrofoil":{
    description:"A packable 150-litre inflatable platform for riders developing their wing-foil skills or travelling with limited storage space. The compact 5'8\" format keeps transport practical, while the dedicated foil connection provides the foundation for progression once the final system bundle is confirmed.",
    bestFor:"Developing wing-foil riders who prioritise packability, convenient storage and an inflatable 150-litre platform.",
    notFor:"Do not place a final order until the exact hydrofoil, wing, fins, bag and accessory bundle has been formally confirmed.",
    why:"The inflatable construction and compact format are centred on transport and storage convenience, with a dedicated connection for the foil system."
  },
  "gannet":{
...
// Latest confirmed Product Catalogue dimensions (2026 V4).
...
Object.assign(products.find(product=>product.slug==="meridian"),{
  ...
  sizeGuide:[
    {size:"9'0\"",width:"21 1/2\"",thickness:"2 3/4\"",volume:"65.49 L"},
    {size:"9'3\"",width:"23\"",thickness:"2 15/16\"",volume:"72.59 L"},
    {size:"9'6\"",width:"23 3/8\"",thickness:"3 1/2\"",volume:"91.14 L"}
  ],
  specs:[["Size range","9'0\"–9'6\""],["Size options","3"],["Colour options","3"],["Core","Premium EPS"],["Deck glass","6 oz + 6 oz + tail patch"],["Fin setup","2+1"]]
});
...
],specs:[["Size range","6'6\"–9'0\""],["Size options","6"],["Colour options","3"],["Construction","25kg EPS blank"],["Top","6oz + Bamboo layer + 4oz + EVA"],["Bottom","6oz + 6oz + HDPE"],["Top stringers","2 × \"T\" stringers"],["Grab handles","2 × grab handles on nose and tail"],["Built-in handle","1 × built-in handle on left centre of the slick"],["EVA","Croc skin pattern"]]});
...
<script id="product-data" type="application/json">${JSON.stringify(pageData).replaceAll("<","\\u003c")}</script><script src="../cart.js?v=20260815-rack-image"></script><script src="../stripe-config.js"></script><script src="../product-page.js?v=20260822-ga4-ecommerce"></script><script src="../cookie-consent.js?v=20260822-ga4-ecommerce"></script></body></html>`;
}
